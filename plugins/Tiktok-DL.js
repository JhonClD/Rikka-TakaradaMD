...
handler.before = async function (m, { conn }) {
  ...
  try {
    ...
    if (listResponse === 'tt_video') {
      ...
      await sendVideo(conn, m, Buffer.from(data));
      return true;
    }
  } catch (e) {
    console.error('[TikTok-DL before]', e.message);
